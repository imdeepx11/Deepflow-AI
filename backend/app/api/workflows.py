...
from app.database.models import Workflow, WorkflowStep, AuditLog
...
def list_workflows(db: Session = Depends(get_db)):
    ...
    for wf in wfs:
        ...
        results.append({
            ...
            "document_name": wf.document.original_filename if wf.document else "Template Workflow",
            "name": wf.name,
    ...
    return [
        {
            ...
            "avg_time": "1.8 hrs",
            "completion_rate": "96%",
            "description": "Automated routing for enterprise invoice audit and finance signoff."
        },
        {
            "id": 2,
            ...
            "avg_time": "4.2 hrs",
            "completion_rate": "91%",
            "description": "Credit check scoring, risk tiering, and credit committee approval."
        },
        {
            "id": 3,
            ...
            "avg_time": "45 min",
            "completion_rate": "98%",
            "description": "Sentiment triage, priority escalation, and support agent assignment."
        },
        {
            "id": 4,
            ...
            "avg_time": "3.5 hrs",
            "completion_rate": "89%",
            "description": "Clause extraction, indemnity check, and legal counsel signoff."
        }
    ]
...
def create_workflow(req: CreateWorkflowRequest, db: Session = Depends(get_db)):
    ...
    log = AuditLog(
        ...
        status="Success",
        details=f"Created custom workflow '{wf.name}' with {len(req.steps)} steps."
    )
    db.add(log)
    db.commit()
